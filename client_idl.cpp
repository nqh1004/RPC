...
int wmain(int argc, wchar_t* argv[])
{
    ...
    hr = CoInitializeSecurity(
        ...
        RPC_C_AUTHN_LEVEL_PKT_INTEGRITY,   // MOI: DCOM hardening (KB5004442) bat buoc toi thieu muc nay
    ...
    if (username && password)
    {
        ...
        authInfo.dwAuthnLevel = RPC_C_AUTHN_LEVEL_PKT_INTEGRITY; // MOI: bat buoc tu DCOM hardening
    ...
    if (username && password)
    {
        hr = CoSetProxyBlanket(
            ...
            RPC_C_AUTHN_LEVEL_PKT_INTEGRITY, RPC_C_IMP_LEVEL_IMPERSONATE,
